package com.sjw.heartchat.receiver;
...
import com.sjw.heartchat.utils.CommonUtils;
 ...
 * 
 */
public class HeartChatMsgReceiver extends BroadcastReceiver {
	...
	private static final String TAG = "HeartChatMsgReceiver";

	@Override
	public void onReceive(Context context, Intent intent) {
		String json = intent.getStringExtra("msg");
		BmobLog.i("收到的message = " + json);
		LogUtil.d("msgJson", json);
		ToastUtil.toast(context, "推送的消息是: " + json);
	...
	private void parseMessage(final Context context, String json)
		...
		BmobChatManager.getInstance(context).createReceiveMsg(json,
				new OnReceiveListener() {
					...
					@Override
					public void onSuccess(BmobMsg arg0) {
						if (ehList.size() > 0) {
							for (int i = 0; i < ehList.size(); i++) {
								EventListener listener = ehList.get(i);
					...
					public void onFailure(int arg0, String arg1) {
						...
						LogUtil.d(TAG, "接收错误..." + arg1);
						ToastUtil.toast(context, "接收错误..." + arg1);
					}
				});
		// JSONObject jo;
		// try {
		...
		// LogUtil.d(TAG, "eventList size "+ehList.size());
	...
	public void showMsgNotify(Context context, BmobMsg msg) {
		...
		// BmobNotifyManager.ge  tInstance(context).showNotifyWithExtras(
	...
	// */
	// public void showOtherNotify(Context context, String username, String
	// toId,
